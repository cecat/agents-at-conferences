...
**Form URL:** https://forms.gle/eQMCRL5wiPsVQTbs7
...
**Success indicator:** The response body will contain the text
`"Thanks for submitting a proposed lightning talk for TPC26!"` if the submission
was accepted.
